...
puts "I thought an undefined variable exception would be thrown but greeting is nil because it got initialized in the block"
...
puts
puts "informal_greeting references greetings. << modifies the object changing greetings."
...
# by the same system. That is, without any form of synchronization, two or more separate computer systems can 
# create new items and label them with a UUID with no significant chance of stepping on each other's toes.
# 
...
##
# Had no idea how to do this until I saw the solution. I searched but couldn't find similar examples/explanations.
##
def generate_UUID
    characters = [] 
